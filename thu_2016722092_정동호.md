...
1. `man`
   <figure>
   ![man wall](C:\Users\chemi\Desktop\college\System_programming\thu_2016722092_정동호.assets\man wall.png)
   <figcaption>그림 2-1-1. man wall</figcaption>
   </figure>

   <figure>
   ![man -k copy](C:\Users\chemi\Desktop\college\System_programming\thu_2016722092_정동호.assets\man -k copy.png)
   <figcaption>그림 2-1-2. man -k copy</figcaption>
   </figure>

   <figure>
   ![man -a write](C:\Users\chemi\Desktop\college\System_programming\thu_2016722092_정동호.assets\man -a write.png)
...
2. `cat`
   <figure>
   ![cat](C:\Users\chemi\Desktop\college\System_programming\thu_2016722092_정동호.assets\cat.png)
...
3. `pwd`
   <figure>![pwd](C:\Users\chemi\Desktop\college\System_programming\thu_2016722092_정동호.assets\pwd.png)
...
4. `cd`
   <figure>![cd](C:\Users\chemi\Desktop\college\System_programming\thu_2016722092_정동호.assets\cd.png)
...
5. `ls`
   <figure>![ls](C:\Users\chemi\Desktop\college\System_programming\thu_2016722092_정동호.assets\ls.png)
...
https://www.interserver.net/tips/kb/learn-linux-file-system-permissions/, 강의자료실-2018-1_SSLab_week02_Unix Linux Commands.pdf &mdash; File permission 부가 설명 제공

`man mkdir` &mdash; 어떻게 mkdir로 subdirectory까지 생성 가능한지 정보 제공
